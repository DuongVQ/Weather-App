 ...
 * @param {number} dateUnix Unix date in seconds
 * @param {number} timezone timezone shift from UTC in seconds
 * @returns {string} tiem string. formate: "HH:MM AM/PM"
 */
 ...
 * @param {number} dateUnix Unix date in seconds
 * @param {number} timezone timezone shift from UTC in seconds
 * @returns {string} tiem string. formate: "HH AM/PM"
 */
...
export const aqiText = {
    ...
    4: {
        level: "Poor",
        message: "Everyone may begin to experience health effects; members of sensitive groups may experienc more serious health effects."
    },
    5: {
        level: "Very Poor",
